<?php
session_start();
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'subvendedor') {
...
$subvendedor_id = $_SESSION['user_id'];
$productos = $conn->query("SELECT * FROM productos WHERE subvendedor_id = $subvendedor_id");
...
// Calcular el total pagado por todos los productos del subvendedor
$total_pagado_query = $conn->query("SELECT SUM(total_pagado) as total FROM productos WHERE subvendedor_id = $subvendedor_id");
...
<head>
    ...
    <title>Subvendedor - Gestión de Productos</title>
...
<body>
    <div class="container mt-5">
        <h2 class="text-center">Subvendedor - Gestión de Productos</h2>
        ...
        <h3 class="mt-4">Total Pagado por todos los Productos</h3>
        <p><strong><?= formatMoney($total_pagado_all) ?></strong></p>
    </div>
